...
const ShellViewport = ({ children }: { children: React.ReactNode }) => {
    ...
    const showSnackbar = useCallback((next: { variant: "success" | "error"; title?: string; message: string }) => {
        setSnackbar((prev) => ({
            key: prev.key + 1,
            open: true,
    ...
    useNotificationsSocket({
        ...
        onMessage: (message) => {
            ...
            if (type === "friend.accepted") {
                const payload = typed.payload as { by?: { display_name?: string } } | undefined;
            ...
            if (type === "invite.accepted") {
                ...
                showSnackbar({
                    variant: "success",
                    message: inviteeName && workspaceName
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background text-foreground">
            ...
            <Snackbar
                ...
                onClose={() => setSnackbar((s) => ({ ...s, open: false, fading: false }))}
            />
