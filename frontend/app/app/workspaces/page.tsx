...
export default function WorkspacesPage() {
    ...
    const inviteUrl = typeof window === "undefined" || !user?.display_name
        ? null
    ...
    return (
        <div className="p-6 space-y-4">
            <div className="flex items-center justify-between gap-3">
                <h1 className="text-xl font-semibold">{t("navigation:workspacesPage.title")}</h1>
                <Button onClick={handleCreate}>{t("navigation:workspacesPage.create")}</Button>
            </div>
...
const WorkspaceIllustration = () => (
    ...
    >
        <rect x="12" y="16" width="196" height="112" rx="14" fill="currentColor" opacity="0.08" />
        <rect x="28" y="34" width="86" height="12" rx="6" fill="currentColor" opacity="0.25" />
        <rect x="28" y="56" width="164" height="10" rx="5" fill="currentColor" opacity="0.18" />
        <rect x="28" y="74" width="142" height="10" rx="5" fill="currentColor" opacity="0.14" />
        <rect x="28" y="92" width="118" height="10" rx="5" fill="currentColor" opacity="0.12" />
